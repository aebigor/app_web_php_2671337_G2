					...
					<fieldset>
						...
						<div class="container-fluid">
							<div class="row">
								...
								<input type="hidden" class="form-control" name="rolCode" id="rolCode" value="<?php echo $rol->getRolCode();?>">
								
								<div class="col-12 col-md-12">
									<div class="form-group">
										<label for="rolName" class="bmd-label-floating">Nombre Rol</label>
										<input type="text" class="form-control" name="rolName" id="rolName" value="<?php echo $rol->getRolName();?>">
									</div>
								</div>
